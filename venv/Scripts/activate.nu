...
def-env activate-virtualenv [] {
    ...
    let virtual_env = 'C:\Users\Pedro Henrique\PycharmProjects\alura-space\venv'
    let bin = 'Scripts'
    let path_sep = ';'
...
alias deactivate = source 'C:\Users\Pedro Henrique\PycharmProjects\alura-space\venv\Scripts\deactivate.nu'
